...
const userTables = {
    ...
    scores: {
        ...
        columns: [
            ...
            { name: 'highest_score_correct_answers', type: 'bigint', notNull: true, default: 0 },
            { name: 'best_streak', type: 'bigint', notNull: true, default: 0 },
            { name: 'current_streak', type: 'bigint', notNull: true, default: 0 },
